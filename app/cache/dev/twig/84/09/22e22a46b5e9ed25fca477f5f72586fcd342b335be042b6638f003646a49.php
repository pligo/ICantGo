...
/* ICantGoStageBundle:Stage:index.html.twig */
class __TwigTemplate_840922e22a46b5e9ed25fca477f5f72586fcd342b335be042b6638f003646a49 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("stage_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 42
        echo $this->env->getExtension('routing')->getPath("stage_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "ICantGoStageBundle:Stage:index.html.twig";
    }
